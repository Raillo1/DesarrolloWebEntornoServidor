/*
Leer la url con sus nombres y valores
 */
package Ejercicios;
...
public class Ejercicio5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h2>Parámetros de la petición</h2>");       
            out.println("<table>");   
            out.println("<tr><th>Parámetros</th><th>Valor</th></tr>");
            
            while (parametros.hasMoreElements()) {
                String parametro = parametros.nextElement();
                String[] valores = request.getParameter(parametro);
                String muestraValores;
                for (String valor : valores) {
                    muestraValores += valor + "<br>";
                }
